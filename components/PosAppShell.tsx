...
export default function PosAppShell({ children }: { children: React.ReactNode }) {
        ...
        {!collapsed && (
          <div className="flex flex-col overflow-hidden">
            <Image
              ...
              className="w-16 h-10"
            />
            <span className="text-[10px] text-sidebar-foreground/60 ml-1">POS</span>
          </div>
        )}
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <div data-theme="pos" className="flex h-screen overflow-hidden bg-background">
        {isMobile ? (
          <>
            <div className="fixed top-0 left-0 right-0 z-50 flex flex-col border-b bg-sidebar md:hidden">
              <div className="flex h-16 items-center gap-3 px-4">
                ...
                <div className="flex flex-col overflow-hidden">
                  ...
                  <span className="text-[10px] text-sidebar-foreground/60">POS</span>
                </div>
