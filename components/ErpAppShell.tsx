...
const NAV_MODULES: NavModule[] = [
  {
    ...
    subItems: [
      { href: "/erp/onboarding", label: "Onboarding Tour", icon: Rocket },
    ],
  },
  {
    id: "dashboard",
    ...
    subItems: [
      { href: "/erp/dashboard", label: "Overview", icon: Eye },
    ],
  },
  {
    id: "invoices",
    ...
    activeBg: "bg-indigo-500/20",
    subItems: [
      { href: "/erp/invoices", label: "All Invoices", icon: Receipt },
    ],
  },
  {
    id: "inventory",
    ...
    subItems: [
      { href: "/erp/inventory", label: "All Products", icon: List },
      { href: "/erp/inventory/add", label: "Add Product", icon: Plus },
      { href: "/erp/inventory/categories", label: "Categories", icon: FileText },
      { href: "/erp/inventory/low-stock", label: "Low Stock Alert", icon: TrendingDown },
    ],
  },
  {
    id: "sales",
    ...
    subItems: [
      { href: "/erp/sales/enquiry", label: "Enquiry", icon: Search },
      { href: "/erp/sales/quotation", label: "Quotation", icon: FileText },
      { href: "/erp/sales/order", label: "Order", icon: ShoppingCart },
      { href: "/erp/sales/challan", label: "Challan", icon: FileText },
      { href: "/erp/sales", label: "Invoice", icon: Receipt },
      { href: "/erp/sales/returns", label: "Return", icon: Trash2 },
      { href: "/erp/sales/performa", label: "Performa", icon: FileText },
      { href: "/erp/sales/cash", label: "Cash", icon: IndianRupee },
      { href: "/erp/sales/other-income", label: "Income thru Other Sales", icon: TrendingUp },
    ],
  },
  {
    id: "purchases",
    ...
    subItems: [
      { href: "/erp/purchases/po", label: "PO", icon: ShoppingCart },
      { href: "/erp/purchases", label: "Invoice", icon: Receipt },
      { href: "/erp/purchases/returns", label: "Return", icon: Trash2 },
      { href: "/erp/purchases/other-expense", label: "Expense thru Other Purchase", icon: TrendingDown },
    ],
  },
  {
    id: "stock",
    ...
    activeBg: "bg-emerald-500/20",
    subItems: [
      { href: "/erp/stock/opening", label: "Opening", icon: Package },
      { href: "/erp/stock/absolute", label: "Absolute", icon: Package },
      { href: "/erp/stock/adjustment", label: "Adjustment", icon: Package },
      { href: "/erp/stock/in", label: "In", icon: TrendingUp },
      { href: "/erp/stock/out", label: "Out", icon: TrendingDown },
    ],
  },
  {
    id: "parties",
    ...
    subItems: [
      { href: "/erp/parties", label: "All Parties", icon: List },
      { href: "/erp/parties/customers", label: "Customers", icon: Users },
      { href: "/erp/parties/suppliers", label: "Suppliers", icon: Users },
      { href: "/erp/parties/add", label: "Add Party", icon: UserPlus },
      { href: "/erp/ledger", label: "Ledger", icon: FileText },
    ],
  },
  {
    id: "certificates",
    ...
    subItems: [
      { href: "/erp/certificates", label: "All Certificates", icon: List },
      { href: "/erp/sales/certificates", label: "Invoice Certificates", icon: Receipt },
    ],
  },
  {
    id: "master",
    ...
    subItems: [
      { href: "/erp/master/groups", label: "Groups", icon: FolderTree },
    ],
  },
  {
    id: "reports",
    ...
    subItems: [
      { href: "/erp/reports", label: "All Reports", icon: FileBarChart },
      { href: "/erp/reports/current-stock", label: "Current Stock", icon: Package },
      { href: "/erp/reports/inventory-report", label: "Inventory Report", icon: FileText },
      { href: "/erp/reports/item-register", label: "Item Register", icon: FileText },
      { href: "/erp/reports/pending-items", label: "Pending Items", icon: TrendingDown },
      { href: "/erp/reports/ledger-outstanding", label: "Ledger Outstanding", icon: Receipt },
      { href: "/erp/reports/ledger-balances", label: "Ledger Balances", icon: FileBarChart },
      { href: "/erp/reports/ledger-register", label: "Ledger Register", icon: FileText },
      { href: "/erp/reports/day-book", label: "Day Book", icon: FileText },
      { href: "/erp/reports/gst-filing", label: "GST Filing", icon: FileText },
    ],
  },
  {
    id: "ai-assistant",
    ...
    subItems: [
      { href: "/erp/ai-assistant", label: "Chat Assistant", icon: Sparkles },
    ],
  },
  {
    id: "settings",
    ...
    subItems: [
      { href: "/erp/settings", label: "All Settings", icon: Settings },
    ],
  },
];

export default function ErpAppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <div data-theme="erp" className="flex h-screen overflow-hidden bg-background">
        {isMobile ? (
          <>
            <div className="fixed top-0 left-0 right-0 z-50 flex flex-col border-b bg-sidebar md:hidden">
              <div className="flex h-16 items-center gap-3 px-4">
                ...
                <div className="flex flex-col overflow-hidden">
                  ...
                  <span className="text-[10px] text-sidebar-foreground/60">ERP Suite</span>
                </div>
