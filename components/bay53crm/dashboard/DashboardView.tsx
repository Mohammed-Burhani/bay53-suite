...
import {
  AlertTriangle, Bell, CheckCircle2, TrendingUp, TrendingDown, Users, IndianRupee, Target, Trophy,
  BarChart3, Activity, Percent, DollarSign, Layers, Eye, EyeOff, X, PieChart as PieChartIcon, FileText,
  Flame, Snowflake, SlidersHorizontal, Download, RotateCcw,
} from "lucide-react";
import {
...
import { useCRMLeads, useCRMNotifications, useCRMCompanyConfig, useCRMMasterValues } from "@/lib/hooks/useCRM";
...
export function DashboardView() {
  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      ...
      {/* ===== ROW 5: Opportunity Pipeline Analytics ===== */}
